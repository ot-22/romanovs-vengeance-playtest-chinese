...
notification-lazarus-shield-ready = 拉撒路护盾准备就绪
notification-lazarus-shield-activated = 警告：拉撒路护盾已激活
notification-lazarus-shield-generator-detected = 警告：检测到拉撒路护盾发射器
...
actor-yagntc =
   .name = 拉撒路护盾产生器
   .description = 拉撒路护盾的产生原理在于彻底扭曲光影
    Kills 步兵.
